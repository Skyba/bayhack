...
<section class='container'>
        ...
        <div class="row">
		 ...
		 <img src="imm.jpg" alt="Logos" height="42" width="42"> 
                <h3>Working in your local Git repository</h3>
                <p>BLA If BLA you created your application from the command line and uploaded your SSH key, rhc will automatically download a copy of that source code repository (Git calls this 'cloning') to your local system.</p>
